...
TEscript="/data/fstein/drivers/run_SC_QuenchTE.jl"
...
if [ "$#" -ne 14 ]; then
    ...
    out="/data/fstein/slurmscripts/SCQuench/Q-N${N}_d${dimsymb}_x${x}_mg_inf-${mg2}_l0_0-${l0_2}_dt${dt}_k${k1}-${kstep}-${k2}_ord${order}_cut${cutoff}_${timestamp}.sh"
