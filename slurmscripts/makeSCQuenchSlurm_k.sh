...
TEscript="/data/fstein/drivers/run_SC_QuenchTE_k.jl"
...
if [ "$#" -ne 14 ]; then
    ...
    out="/data/fstein/slurmscripts/SCQuench_k/Qk-N${N}_d${dimsymb}_x${x}_mg_inf-${mg2}_l0_0-${l0_2}_k${k}_t${t1}-${tstep}-${t2}_ord${order}_cut${cutoff}_${timestamp}.sh"
