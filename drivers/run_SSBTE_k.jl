...
if length(ARGS) == 13
    ...
    outputname = string(dirname, "out/SSBTE/", "N", N, "_d", dimension, truncstr, "_X", x, "_mg", mg, "_l0", l0, "_N1-", N1, "_N2-", N2, "_dt", dt, "_k", k, "_order", order, "_cutoff", cutoff, ".out")
    ...
    open(outputname, "w") do file
        redirect_stdout(file) do
            ...
            psiStr = applyStringMPO(N1, N2, s, psi0, truncation=trunc)
    ...
    println("Wrong number of arguments. Usage:")
        println("run_SSBTE.jl N d truncation x m/g l0 N1 N2 dt k  order cutoff basedir")
    end
